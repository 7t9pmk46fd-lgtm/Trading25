...
sys.path.insert(0, str(Path(__file__).resolve().parent.parent.parent))  # trading-desk root, for `shared`
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))          # execution-agent, for alpaca_client
